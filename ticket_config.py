...
bot = telebot.TeleBot('5287625176:AAG6Hgwn4IuM1QdEN_Z6wUugZBe6gSwHpYo') # Токен бота воркеров

admin = 2097409475 # ID Админа
support = 2097409475 # ID сапорта
channel_id = -1001177080300 # ID Канала залётов
chat_worker_id = -1001596849089 # ID Чата с воркерами

bot_name = 'borkeri_bot' # Username Бота

mater = '' # Ссылка на мануалы
zalet = 'https://t.me/+S1SykDp600tkOTYy' # Ссылка на канал с залётами
infos = '' # Ссылка на инфо канал
pname = 'Luna Casino' # Название проекта
pdate = '15.02.2022' # Дата созданя проекта
